...
//function for centralise the rods and ball
...
//function for the movement of rods as per user
function add_event_listener_to_rods() {
  window.addEventListener("keydown", function (event) {
    let code = event.keyCode;
    //asci value of d is 68 which takes both rods towards right
    if (code == 68) {
    ...
    //asci value of a is 65 which takes both rods towards left
    else if (code == 65) {
      let left_numeric = parseInt(
        first_rod.style.left.substring(0, first_rod.style.left.length - 2)
      );
...
//function for ball touching rod1 and taking movements
...
//function for moving ball touching rod2 and taking movements
...
//function to set interval for ball while start the game
...
//function to show the score of both the rods
function show_score() {
